...
Pinned versions live under [`versions/`](versions/). Android 15 is the default baseline, while Android 14, 16, and 17 are also configured. See [`../docs/android-versions.md`](../docs/android-versions.md) for the support matrix.
