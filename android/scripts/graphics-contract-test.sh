...
grep -Fxq 'ROYD_ANDROID_VERSION := 15' "$work/vendor/royd/version.mk"
grep -Fxq 'ROYD_SOFTWARE_EGL := angle' "$work/vendor/royd/version.mk"
grep -Fxq 'ROYD_SOFTWARE_EGL := angle' "$work/vendor/royd/graphics_backend.mk"
grep -Fxq 'ROYD_GRAPHICS_ALLOCATOR := aidl2-stablec5-memfd' "$work/vendor/royd/graphics_backend.mk"
grep -Fxq 'ROYD_GRAPHICS_COMPOSER := aidl4-client' "$work/vendor/royd/graphics_backend.mk"
grep -Fq '$(SRC_TARGET_DIR)/product/angle_default.mk' "$work/vendor/royd/graphics_backend.mk"
grep -Fq 'ro.hardware.vulkan=pastel' "$work/vendor/royd/graphics_backend.mk"
grep -Fq 'vulkan.pastel' "$work/vendor/royd/graphics_backend.mk"
...
grep -Fxq 'ROYD_ANDROID_VERSION := 14' "$work/vendor/royd/version.mk"
grep -Fxq 'ROYD_SOFTWARE_EGL := swiftshader' "$work/vendor/royd/version.mk"
grep -Fxq 'ROYD_SOFTWARE_EGL := swiftshader' "$work/vendor/royd/graphics_backend.mk"
grep -Fxq 'ROYD_GRAPHICS_ALLOCATOR := gralloc0-memfd' "$work/vendor/royd/graphics_backend.mk"
grep -Fxq 'ROYD_GRAPHICS_COMPOSER := 2.4' "$work/vendor/royd/graphics_backend.mk"
