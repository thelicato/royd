...
build-helper-test:
	./scripts/build-helper-test.sh


android-sync-contract-test:
	./android/scripts/sync-contract-test.sh

android-aosp-shell-test:
...
android-vintf-contract-test:
	./android/scripts/vintf-contract-test.sh

android15-build-readiness-test:
	./android/scripts/android15-build-readiness-test.sh

android15-vold-container-test:
	./android/scripts/android15-vold-container-test.sh
